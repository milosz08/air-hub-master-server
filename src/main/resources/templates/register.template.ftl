...
<#assign registeredTop = i18n("airhubmaster.email.fragment.registeredTop")>
<#assign registeredBottom = i18n("airhubmaster.email.fragment.registeredBottom", [ expirationHours ])>
