...
public class AccountException {
    ...
    @Slf4j public static class LoginAlreadyExistException extends RestServiceAuthServerException {
    ...
    @Slf4j public static class EmailAddressAlreadyExistException extends RestServiceAuthServerException {
